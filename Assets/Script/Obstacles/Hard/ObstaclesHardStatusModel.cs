...
namespace Script.Obstacles.Hard {
	public class ObstaclesHardStatusModel : IObstaclesStatusModel, IObstaclesDamageable, IObstaclesChargeable {
		...
		public ObstaclesHardStatusModel(int hp = 3, int chargeAmount = 1) {
			_hp.Value = hp;
			MaxHp = _hp.Value;
